...
const Cart = ({ setOpenCart }) => {
  ...
  const removeFromCartHadler = (data) => {
                ...
                {cart &&
                  cart.map((i, index) => (
                    <CartSingle
                      ...
                      removeFromCartHadler={removeFromCartHadler}
                    />
                  ))}
              </div>
            </div>
...
const CartSingle = ({ data, qtyChangeHandler, removeFromCartHadler }) => {
      ...
      <div className="w-full flex items-center">
        ...
        <div className="pl-[5px]">
          ...
          <div className="flex items-center justify-between">
            ...
            <RxCross1
              className="cursor-pointer"
                onClick={() => removeFromCartHadler(data)}
            />
          </div>
        </div>
      </div>
