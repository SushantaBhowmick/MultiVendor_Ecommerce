  ...
  return (
    <div className={`${styles.section} py-4 min-h-screen`}>
        <div className="w-full flex items-center justify-between">
            ...
            <div className={`${styles.button} text-[#e94560] !bg-[#fce1e6] !rounded-[4px] font-[600] !h-[45px] text-[18px]`}>
                Order List
            </div>
            </Link>
        </div>
        ...
        <div className="w-full flex items-center justify-between pt-6">
            <h5 className='text-[#00000084]'>Order ID: <span>#{data?._id}</span></h5>
