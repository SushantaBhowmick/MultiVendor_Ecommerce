...
const Footer = () => {
  return (
    <>
      <div className="text-white bg-[#000]">
        <div className="md:flex md:justify-between md:items-center sm:px-12 px-4 py-7 bg-[#342ac8]">
          ...
          <div>
            ...
            />
            <button className="bg-[#56d879] hover:bg-teal-500 duration-300 px-5 py-2.5 rounded-md text-whtie md:w-auto w-full">
              Submit
            </button>
          </div>
        </div>
      ...
      >
        <span>© 2024 RsCompany. All rights reserved.</span>
